...
-- Adicionar uma constraint a tabela fornecedor 
...
-- Alterar tabela produto adicionando uma constraint e relacionamento
...
-- Alterar tabela lote adicionando uma chave estrangeira e realizando
...
ALTER TABLE detalhevenda ADD CONSTRAINT `fk.detalhe_pk.produto`
...
!["Modelo Relacional"](modelorelacional-casaoliveira.png)